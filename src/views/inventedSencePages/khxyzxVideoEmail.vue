<template>
  <div class="dt">
    ...
    <div class="kuang" :class="{'kuangExpand':kuangExpand}" @click.stop="replay">
      <video class="v" src="../../assets/videos/khxyzxVideoEmail.mp4" autoplay muted controls
        ref='v'
...
export default {
  ...
  mounted(){
    ...
    this.title = this.$store.state.customMade.mesages.khxyzx ? 
    this.$store.state.customMade.mesages.khxyzx : 
