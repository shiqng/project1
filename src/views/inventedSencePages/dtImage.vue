<template>
  <div class="dt">
     <div class="title">GTAC Romania</div>
    <div class="kuang" :class="{'kuangExpand':kuangExpand}">
      <!-- <img src="../../assets/videos/dt.png" alt="" srcset=""> -->
...
.kuang{
  ...
  transition: all 0.5s;
  z-index: 1000;
  background: url('../../assets/videos/dt.png') center center / 100% 100% no-repeat ;
}
.kuangExpand{
  width: 100% !important;
